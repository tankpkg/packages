...
```bash
# Server-only values — never exposed to the client bundle
# (Fill in real values from your secrets manager; do not commit literals.)
DATABASE_URL=          # full Postgres DSN from secret store
